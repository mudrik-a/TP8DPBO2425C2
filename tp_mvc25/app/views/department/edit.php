...
<form method="POST">
    ...
    <label>Nama</label>
    <input type="text" name="name" value="<?= $department['name'] ?>" class="form-control mb-2">

    <label>Deskripsi</label>
    <textarea name="description" class="form-control mb-2"><?= $department['description'] ?></textarea>
